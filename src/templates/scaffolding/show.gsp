...
<html>
    <head>
        ...
        <title><g:message code="${domainClass.propertyName}.show" default="Show ${domainClass.naturalName}" /></title>
    </head>
    <body>
        <div class="nav">
            <span class="menuButton"><a class="home" href="\${createLinkTo(dir: '')}"><g:message code="home" default="Home" /></a></span>
            <span class="menuButton"><g:link class="list" action="list"><g:message code="${domainClass.propertyName}.list" default="${domainClass.naturalName} List" /></g:link></span>
        ...
        <div class="body">
            <h1><g:message code="${domainClass.propertyName}.show" default="Show ${domainClass.naturalName}" /></h1>
                    ...
                    <table>
                        ...
                        <%  excludedProps = ["version",
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value"><g:link controller="profile" action="show" id="\${${propertyName}?.${p.name}?.id}">\${${propertyName}?.${p.name}}</g:link></td>                             
                                <%  } else if (p.oneToMany || p.manyToMany) { %>
                                <td  valign="top" style="text-align: left;" class="value">
                                    <ul>
                                    <g:each in="\${${propertyName}?.${p.name}}" var="${p.referencedDomainClass?.propertyName}Instance">
                                        <li><g:link controller="${p.referencedDomainClass?.propertyName}" action="show" id="\${${p.referencedDomainClass?.propertyName}Instance.id}">\${${p.referencedDomainClass?.propertyName}Instance}</g:link></li>
                                    </g:each>
                                    </ul>
                                </td>
