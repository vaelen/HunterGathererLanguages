// This class functions as a mixin.  That is, it adds the closures below to
// the classes into which it is "mixed in" (which a @Mixin() annotation).
// Mixins are a weird hack that do something similar to multiple inheritance.
